...
BOOST_AUTO_TEST_CASE(MatchPinyin) {
    ...
    BOOST_CHECK(pinyin::match_pinyin(U'拼', U"pny;", pinyin::PinyinFlag::DoublePinyinMicrosoft) == 2);
    BOOST_CHECK(pinyin::match_pinyin(U'英', U"y;", pinyin::PinyinFlag::DoublePinyinMicrosoft) == 2);
